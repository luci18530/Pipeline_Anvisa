...
# Adicionar diretórios src das pipelines ao path
CURRENT_DIR = Path(__file__).resolve().parent
PIPELINE_ROOT = CURRENT_DIR.parent
NFE_SRC = PIPELINE_ROOT / "src"
ANVISA_SRC = PIPELINE_ROOT.parent / "anvisa_base" / "src"

for extra_path in (NFE_SRC, ANVISA_SRC):
