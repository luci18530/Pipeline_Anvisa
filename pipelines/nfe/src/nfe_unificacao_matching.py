...
def _resolver_anvisa_output_path():
    """Retorna caminho preferencial da base ANVISA ou None se inexistente."""
    candidatos = [
    ...
    for caminho in candidatos:
        if caminho.exists():
            if caminho == candidatos[1]:
                print(
                    "[AVISO] Base ANVISA localizada em output/baseANVISA.csv. "
                    "Prefira mantê-la em output/anvisa/baseANVISA.csv."
                )
            return caminho
    return None
