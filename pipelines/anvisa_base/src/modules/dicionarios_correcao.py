...
DICIONARIO_DE_CORRECAO = {
    ...
    "BUTILBROMETO DE ESCOPOLAMINA + DIPIRONA + ESCOPOLAMINA": "BUTILBROMETO DE ESCOPOLAMINA + DIPIRONA",
...
DIC_SUGERIDO_ATIVO = {
    ...
    "AMOXICILINA SODICA + SULBACTAM PIVOXILA PIVOXILA": "AMOXICILINA SODICA + SULBACTAM PIVOXILA",
