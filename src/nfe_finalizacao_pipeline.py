...
# Caminhos
INPUT_ZIP = BASE_DIR / 'data' / 'processed' / 'df_etapa15_resultado_matching_hibrido.zip'
OUTPUT_DIR = BASE_DIR / 'data' / 'processed'

OUTPUT_MATCHED = OUTPUT_DIR / 'df_etapa16_matched_hibrido.zip'
OUTPUT_RESTANTE = OUTPUT_DIR / 'df_etapa16_restante.zip'
OUTPUT_ATRIBUTOS_IA = OUTPUT_DIR / 'df_etapa16_atributos_ia.zip'
