...
# Caminhos dos inputs
INPUT_COMPLETO = BASE_DIR / 'data' / 'processed' / 'df_etapa09_completo.zip'
INPUT_APRESENTACAO = BASE_DIR / 'data' / 'processed' / 'df_etapa13_match_apresentacao_unica.zip'
INPUT_HIBRIDO = BASE_DIR / 'data' / 'processed' / 'df_etapa16_matched_hibrido.zip'
